...
const CategoryBox = ({ title, count, icon, badgeText, badgeColor }) => (
  <div className="card border-right">
    <div className="card-body">
      <div className="d-flex d-lg-flex d-md-block align-items-center">
        <div>
          <div className="d-inline-flex align-items-center">
            <h2 className="text-dark mb-1 font-weight-medium">{count}</h2>
            <span
              className={`badge font-12 text-white font-weight-medium badge-pill ml-2 ${
